...
object CookingAgentPrompts {
    ...
    /**
     * A prompt for the cooking agent to plan and order the ingredients for cooking a specific dish.
     */
    val planAndOrderCookingSystemPrompt = markdown {
        ...
        bulleted {
            ...
            +"Then you can put one of the matching ingredient in the web shop basket using ${CookingAgentTools::addProductToCart.name}"
